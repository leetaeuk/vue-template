<template>
    <v-app>
        ...
        <v-main>
            <div class="app-content-container boxed-container pa-0">
                <slot></slot>
            </div>
        </v-main>
        ...
        >
            <div class="boxed-container w-full">
                <div class="mx-6 d-flex justify-space-between">
                    <span>&copy; 2021 <a href="https://ebizm.daegubank.co.kr" class="text-decoration-none" target="_blank">eBiz Manager</a></span>
                    <!--
